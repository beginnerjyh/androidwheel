package com.example.androidwheel;
...
public class MainActivity extends Activity implements OnWheelChangedListener{
	...
	private void updateAreas()
	{
		...
		mCurrentCityName = mCitisDatasMap.get(mCurrentProviceName) == null ? "" : mCitisDatasMap.get(mCurrentProviceName)[pCurrent];
	...
	public void onChanged(WheelView wheel, int oldValue, int newValue) {
		if(wheel == mProvince){
			updateCities();
			mCurrentAreaName = mAreaDatasMap.get(mCurrentCityName)==null?"":mAreaDatasMap.get(mCurrentCityName)[0];
		}else if(wheel == mCity){
			updateAreas();
			mCurrentAreaName = mAreaDatasMap.get(mCurrentCityName)==null?"":mAreaDatasMap.get(mCurrentCityName)[0];
		}else if(wheel == mArea){
